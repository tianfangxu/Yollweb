...
public class RedisLock {
     ...
     * 锁等待时间，防止线程饥饿，微妙
     */
    private int timeoutMsecs = 50;

    private volatile boolean locked = false;

    /**
     * Detailed constructor with default acquire timeout 50 msecs and lock expiration of 60000 msecs.
     *
    ...
    /**
     * Detailed constructor with default lock expiration of 50 msecs.
     *
     */
    ...
    public synchronized boolean lock() throws InterruptedException {
        ...
        if(logger.isInfoEnabled()) {
          logger.info(lockKey + " : get lock timeout...");
        }
        return false;
    }
