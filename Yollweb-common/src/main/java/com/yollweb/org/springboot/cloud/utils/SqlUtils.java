...
public class SqlUtils {
    ...
    public static int getCount(final String sql, final Connection connection,
        ...
        try {
            ...
            if (BeanUtils.getPropertyValue(boundSql, "metaParameters") != null) {
                ...
                BeanUtils.setPropertyValue(countBS, "metaParameters", mo);
            }
    ...
    private static String removeOrders(String qlString) {
    	String newSqlString = qlString.toLowerCase();
    	int index = newSqlString.indexOf("order by");
    	if(index != -1 && newSqlString.substring(index).indexOf("?") == -1) {
    		return newSqlString.substring(0, index);
    	} else {
    		return qlString;
    	}
