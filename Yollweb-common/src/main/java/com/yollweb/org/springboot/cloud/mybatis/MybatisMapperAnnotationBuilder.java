...
import com.yollweb.org.springboot.cloud.mybatis.sqlprovider.DefaultSqlSource;
import com.yollweb.org.springboot.cloud.mybatis.sqlprovider.SqlMethod;
...
public class MybatisMapperAnnotationBuilder {
    ...
    private Class<?> type;
    private DefaultSqlSource defaultSqlSource = new DefaultSqlSource();
    ...
    public void parseStatement(Method method) {
        ...
        SqlSource sqlSource = getSqlSource(method, parameterTypeClass, languageDriver);
        if (sqlSource != null) {
    ...
    private SqlSource getSqlSource(Method method, Class<?> parameterType, LanguageDriver languageDriver) {
        try {
            return defaultSqlSource.getSqlSource(type, method, configuration, languageDriver);
        } catch (Exception e) {
    ...
    private SqlCommandType getSqlCommandType(Method method) {
        return SqlMethod.valueOf(method.getName()).getType();
    }
